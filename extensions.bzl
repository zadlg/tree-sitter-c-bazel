...
load(":repositories.bzl", "DEFAULT_INTEGRITY", "DEFAULT_VERSION", "tree_sitter_c_build_http_archive_arguments")

def _tree_sitter_c_sources_extension_impl(mctx):
...
tree_sitter_c_source_code = module_extension(
    implementation = _tree_sitter_c_sources_extension_impl,
    doc = """Tree-sitter C parser source code extension""",
    tag_classes = {
